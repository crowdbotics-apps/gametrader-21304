"""gametrader_21304 URL Configuration
...
admin.site.site_header = "GameTrader"
admin.site.site_title = "GameTrader Admin Portal"
admin.site.index_title = "GameTrader Admin"

# swagger
api_info = openapi.Info(
    title="GameTrader API",
    default_version="v1",
    description="API documentation for GameTrader App",
)
